...
$category_color = isset($grid['grid_config']['category_color']) ? $grid['grid_config']['category_color'] : '#343434';
$category_hover_color = isset($grid['grid_config']['category_hover_color']) ? $grid['grid_config']['category_hover_color'] : '#5d97af';
$background_color = isset($grid['grid_config']['background_color']) ? $grid['grid_config']['background_color'] : 'rgba(0,0,0,0.8)';
$no_image_bg_color = isset($grid['grid_config']['no_image_bg_color']) ? $grid['grid_config']['no_image_bg_color'] : '#5d97af';
$icon_color = isset($grid['grid_config']['icon_color']) ? $grid['grid_config']['icon_color'] : '#fff';
$icon_hover_color = isset($grid['grid_config']['icon_hover_color']) ? $grid['grid_config']['icon_hover_color'] : '#5d97af';
$title_color = isset($grid['grid_config']['title_color']) ? $grid['grid_config']['title_color'] : '#fff';
$title_hover_color = isset($grid['grid_config']['title_hover_color']) ? $grid['grid_config']['title_hover_color'] : '#5d97af';
$excerpt_color = isset($grid['grid_config']['excerpt_color']) ? $grid['grid_config']['excerpt_color'] : '#fff';
