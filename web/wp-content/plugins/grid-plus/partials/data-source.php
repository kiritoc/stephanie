...
$order_by = isset($grid['grid_data_source']['order_by'] ) && is_array($grid['grid_data_source']['order_by']) ? implode(',', $grid['grid_data_source']['order_by']) : '';
    ...
    <div class="col-md-6">
        <div class="form-groups">
            ...
            <div class="form-group" >
                ...
                <div class=" col-xs-8">
                    <input type="checkbox"
                           id="layout_cate_multi_line" <?php if (isset($grid['grid_config']['cate_multi_line']) && $grid['grid_config']['cate_multi_line'] == 'true') {
                        echo 'checked';
                    } ?> >
                </div>
            </div>
