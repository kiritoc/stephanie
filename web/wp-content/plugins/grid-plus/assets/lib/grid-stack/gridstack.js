    ...
    GridStack.prototype._updateStyles = function(maxHeight) {
        ...
        if (!this.opts.verticalMargin || this.opts.cellHeightUnit === this.opts.verticalMarginUnit) {
            getHeight = function(nbRows, nbMargins) {
                var $layout = $('.grid-stack','.grid-stack-container').attr('data-layout');
                if($layout=='grid'){
                    var $row =  nbRows / parseInt( $('.grid-stack-item:first-child','.grid-stack').attr('data-gs-height') );
                    if(isNaN($row)){
                        $row = 0;
                    }else{
                        $row = Math.floor($row) - 1;
                    }
                    return (self.opts.cellHeight * nbRows + self.opts.verticalMargin * $row) +
            ...
            getHeight = function(nbRows, nbMargins) {
                ...
                if($layout=='grid'){
                    ...
                    return 'calc(' +
                        ((self.opts.cellHeight * nbRows) + self.opts.cellHeightUnit) + ' + ' +
                        ((self.opts.verticalMargin * $row) + self.opts.verticalMarginUnit) + ')';
                }else{
                    return 'calc(' +
                        ((self.opts.cellHeight * nbRows) + self.opts.cellHeightUnit) + ' + ' +
