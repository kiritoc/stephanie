...
class AgileStoreLocator {
	...
	public function load_plugin_textdomain() {
        ...
        $mo_file = WP_LANG_DIR . '/' . 'agile-store-locator' . '/' . $domain . '-' . get_locale() . '.mo';
	...
	public function add_admin_menu() {
		...
		if (current_user_can('delete_posts')){
			...
			add_submenu_page( 'asl-plugin', 'Manage Stores', 'Markers (Pro)', 'delete_posts', 'manage-store-markers', array($this->plugin_admin,'admin_store_markers'));
			add_submenu_page( 'asl-plugin', 'Import/Export Stores', 'Import Stores (Pro)', 'delete_posts', 'import-store-list', array($this->plugin_admin,'admin_import_stores'));
			...
			add_submenu_page( 'asl-plugin', 'Customize Map', 'Customize (Pro)', 'delete_posts', 'customize-map', array($this->plugin_admin,'admin_customize_map'));
