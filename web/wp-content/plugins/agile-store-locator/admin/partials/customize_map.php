  ...
  <div>
	...
	<div class="well">
        <div class="row map-option-top" style="margin-bottom:10px">
            ...
            <div class="col-md-3">
            	<button class="btn btn-warning" onclick="asl_lock()" type="button" id="asl-delete-shape"><span style="margin-right:10px;font-size:12px" class="glyphicon glyphicon-trash"></span><span>Delete</span></button>
            	<button class="btn btn-danger" onclick="asl_lock()" type="button" id="asl-clear-all"><span>Clear All</span></button>
            </div>
            <div class="col-md-7">
...
<script type="text/javascript">
	...
	asl_engine.pages.customize_map();
</script>