			...
			<div id="PO-tab-1-content" class="PO-tab-content active">
				...
				<div id="PO-gen-settings-div">
					...
					<div class="inside">
						...
						<div class="stuffbox">
							<?php $disableByRole = get_option("PO_disable_by_role"); ?>
							<div class="PO-settings-button-container">
								<input type="checkbox" id="PO-disable-by-role" name="PO_disable_by_role" class="hidden-checkbox" <?php print ($disableByRole === "1")? 'checked="checked"':""; ?>>
								<input type="button" id="PO-disable-by-role-button" class="toggle-button-<?php print ($disableByRole === "1")? "on":"off"; ?>" value="<?php print ($disableByRole === "1")? "On":"Off"; ?>"  onclick="PO_toggle_button('PO-disable-by-role', '', 0);" />
							</div>
							<h4>
							  <label for="PO_disable_by_role">Disable Plugins By Role</label>
							  <a href="#" title="Disable Plugins By Role" onclick="PO_display_ui_dialog('Disable Plugins By Role', 'This gives you the ability to disable/enable plugins differently based on the users role and if they are logged in.');return false;">
								<span class="dashicons PO-dashicon dashicons-editor-help"></span>
							  </a>
							</h4>
						</div>

						<div id="PO-role-container" class="stuffbox">
							<h4>
							  <label for="PO_enabled_roles">Role Support</label>
							  <a href="#" onclick="PO_display_ui_dialog('Role Support', 'This is a list of roles on your wordpress install.  Select the checkbox next to the role you would like to disable/enable plugins for.  Only the roles you select here will be available on the post edit screen.  You can drag and drop the different roles to set their priority.  The first one in the list has the highest priority.  If you don\'t select any roles you will still be able to disable/enable plugins based on whether a person is logged in or not.  Use of this feature requires that Disable Plugins By Role be turned on.');return false;">
								<span class="dashicons PO-dashicon dashicons-editor-help"></span>
							  </a>
							</h4>
